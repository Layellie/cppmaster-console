...
- **Phase 8 — Ayarlar (Settings): COMPLETE** (commits `d74a526..da06736`,
...
- **Phase 9 — Konu kilidi sistemi: COMPLETE** (commits `c249a2a..0fa476a`,
...
- **Phase 10 — İpucu sistemi: COMPLETE** (commits `6fa0a55..4965c73`, 76/76
...
- **Phase 11 — Kod Yazma Alıştırmaları modu: COMPLETE** (commits
  `7e71ba1..6377d42`, 83/83 tests + ctest 100%). 25 hand-authored
...
- **Phase 12 — Adaptif zorluk sistemi: COMPLETE** (commits `2c11430..48b765e`,
...
- **Phase 13 — Bölüm 2 İçerik Genişletmesi: COMPLETE** (commits
  `a8f3b50..9b1535c`, 89/89 tests + ctest 100%). Topics 11-20 (Section 2:
...
- **Phase 14 — Bölüm 3 İçerik Genişletmesi: COMPLETE** (commits
  `a29a9e6..5ca5b76`, 90/90 tests + ctest 100%). Topics 21-30 (Section 3:
...
- **Phase 15 — Bölüm 4 İçerik Genişletmesi: COMPLETE** (commits
  `79160c0..9c3905b`, 91/91 tests + ctest 100%). Topics 31-40 (Section 4:
...
- **Phase 24 — Büyük ölçekli üretim testleri: COMPLETE** (commits
  `73111b8..2be9935`; new suite 2/2, existing suite 202/202 + ctest 100%
...
- **Phase 25 — Kalan cila: COMPLETE** (commits `6696380..980f158`,
