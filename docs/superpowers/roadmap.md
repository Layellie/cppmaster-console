...
- **Phases 20-21 — İçerik genişletme (devamı):** kalan 20 konunun ders
  içeriği + soru bankasının ~580'e çıkarılması. Bölüm bölüm (Section 9
  through Section 10, 2 phases), her biri o bölümün 10 konusu + ~290 soru.
...
Phase 19 complete (2026-07-18). Phase 20 (Section 9 content: "STL veri
yapıları", topics 81-90) starting next — the eighth of the large
